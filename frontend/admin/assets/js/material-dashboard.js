...
function sidebarType(a) {
  ...
  if ((color == 'bg-transparent' || color == 'bg-white') && bodyWhite) {
    ...
    if (navbarBrandImg.includes('logo-clothify.png')) {
        navbarBrand.src = navbarBrandImg.replace('logo-clothify.png', 'logo-clothify-dark.png');
      }
    } else {
      var navbarBrand = document.querySelector('.navbar-brand-img');
      var navbarBrandImg = navbarBrand.src;
      if (navbarBrandImg.includes('logo-clothify-dark.png')) {
        navbarBrand.src = navbarBrandImg.replace('logo-clothify-dark.png', 'logo-clothify.png');
      }
    }
