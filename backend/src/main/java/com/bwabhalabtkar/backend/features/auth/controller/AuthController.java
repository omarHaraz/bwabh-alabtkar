package com.bwabhalabtkar.backend.features.auth.controller;

import com.bwabhalabtkar.backend.common.infrastructure.email.EmailService;
import com.bwabhalabtkar.backend.common.security.JwtTokenProvider;
import com.bwabhalabtkar.backend.features.auth.dto.request.ForgotPasswordRequest;
import com.bwabhalabtkar.backend.features.auth.dto.request.LoginRequest;
import com.bwabhalabtkar.backend.features.auth.dto.request.OtpVerificationRequest;
import com.bwabhalabtkar.backend.features.auth.dto.request.ResendOtpRequest;
import com.bwabhalabtkar.backend.features.auth.dto.request.ResetPasswordRequest;
import com.bwabhalabtkar.backend.features.auth.dto.request.ResetPasswordVerificationRequest;
import com.bwabhalabtkar.backend.features.auth.dto.request.SignupRequest;
import com.bwabhalabtkar.backend.features.auth.dto.response.CurrentUserResponse;
import com.bwabhalabtkar.backend.features.auth.dto.response.JwtAuthenticationResponse;
import com.bwabhalabtkar.backend.features.auth.entity.PendingPasswordReset;
import com.bwabhalabtkar.backend.features.auth.entity.PendingSignup;
import com.bwabhalabtkar.backend.features.auth.service.OtpService;
